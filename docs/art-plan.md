...
Working plan for giving Gaime2 its visual identity. Derived directly from the
...
- Final **game name** + logo direction — "Gaime2" stays the placeholder
  wordmark; renaming is a product call.
