...
|------|--------------------|-------------|
| **Terrain** (`data/terrain.ts`) | 5 flat colours: plains `#8fae5d`, forest `#3f7a4f`, hills `#a98b52`, mountains `#7c7f88`, coast `#4a89b8` | 5 tileable/shadeable terrain fills or textures + coastline/border treatment + a world background (replaces flat `#11151c`) |
