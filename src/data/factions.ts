...
export const FACTIONS: FactionDef[] = [
  ...
  { name: "Novgorod", color: "#b06ec0", trait: "scholarly", disposition: "builder", homeFocus: "academy", blurb: "A Rus merchant-republic of chronicles and learning.",
    bonus: { label: "The Chronicles", detail: "Begin with the Monastic Orders doctrine — the Monastery.", startTech: "monastic_orders" } },
  ...
  { name: "Prussia", color: "#8f86d8", trait: "industrious", disposition: "builder", homeFocus: "workshop", blurb: "Baltic tribes turned tireless builders of the shore.",
    bonus: { label: "The builders", detail: "Begin with the Craft Workshops doctrine.", startTech: "craft_workshops" } },
  ...
  { name: "Poland", color: "#d64f7d", trait: "fertile", disposition: "opportunist", homeFocus: "farmland", blurb: "The rich Vistula grainlands feed a growing realm.",
    bonus: { label: "The breadbasket", detail: "Begin with the Council Oversight doctrine.", startTech: "council_oversight" } },
  ...
  { name: "Finland", color: "#9ec96b", trait: "industrious", disposition: "builder", homeFocus: "workshop", blurb: "Forest-folk and craftsmen of the far northern shore.",
    bonus: { label: "Forest wardens", detail: "Begin with the Town Watch doctrine — Pikemen.", startTech: "town_watch" } },
  ...
  { name: "Cologne", color: "#2f8f7f", trait: "industrious", disposition: "builder", homeFocus: "workshop", blurb: "The great Rhineland see — masons, founders and river-trade of the Empire.",
    bonus: { label: "Rhineland forges", detail: "Begin with the Bulk Mining doctrine.", startTech: "bulk_mining" } },
  { name: "Saxony", color: "#4e9b45", trait: "industrious", disposition: "builder", homeFocus: "workshop", blurb: "The Saxon dukes of the inland towns, rich in Harz silver and hard labour.",
    bonus: { label: "Harz silver", detail: "Begin with the Exclusive Charters doctrine.", startTech: "exclusive_charters" } },
