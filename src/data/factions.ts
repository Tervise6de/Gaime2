...
export const FACTIONS: FactionDef[] = [
  { name: "Sweden", color: "#5b8bd0", trait: "martial", disposition: "warlord", blurb: "Northern warrior-kings — armies raised cheap and fierce.",
    bonus: { label: "Viking host", detail: "Begin with a veteran Infantry regiment.", startUnits: { infantry: 1 } } },
  { name: "Denmark", color: "#d0796e", trait: "mercantile", disposition: "merchant", blurb: "A seafaring crown that lives by Baltic trade and gold.",
    bonus: { label: "Sound toll", detail: "Begin with +45 gold from the strait tolls.", startGold: 45 } },
  { name: "Novgorod", color: "#b06ec0", trait: "scholarly", disposition: "builder", blurb: "A Rus merchant-republic of chronicles and learning.",
    bonus: { label: "The Chronicles", detail: "Begin with Writing already known.", startTech: "writing" } },
  { name: "Lithuania", color: "#6cae7a", trait: "martial", disposition: "opportunist", blurb: "Pagan grand-dukes and their dreaded horse-armies.",
    bonus: { label: "The horse levy", detail: "Begin with two extra Militia regiments.", startUnits: { militia: 2 } } },
  { name: "Prussia", color: "#8f86d8", trait: "industrious", disposition: "builder", blurb: "Baltic tribes turned tireless builders of the shore.",
    bonus: { label: "The builders", detail: "Begin with Pottery already known (the Granary).", startTech: "pottery" } },
  { name: "Livonia", color: "#4fb0a0", trait: "industrious", disposition: "builder", blurb: "Order-forts and stone towns rise across the coast.",
    bonus: { label: "Stone towns", detail: "Begin with +35 gold from the burgher charters.", startGold: 35 } },
  { name: "Poland", color: "#d64f7d", trait: "fertile", disposition: "opportunist", blurb: "The rich Vistula grainlands feed a growing realm.",
    bonus: { label: "The breadbasket", detail: "Begin with Agriculture already known.", startTech: "agriculture" } },
  { name: "Curonia", color: "#d99a4f", trait: "mercantile", disposition: "merchant", blurb: "Amber-coast traders and raiders of the western sea.",
    bonus: { label: "Amber trade", detail: "Begin with +40 gold from the amber road.", startGold: 40 } },
  { name: "Estonia", color: "#6fc2d8", trait: "fertile", disposition: "builder", blurb: "Free tribal farmers of the northern woods and bogs.",
    bonus: { label: "Tribal levies", detail: "Begin with two extra Militia regiments.", startUnits: { militia: 2 } } },
  { name: "Finland", color: "#9ec96b", trait: "industrious", disposition: "builder", blurb: "Forest-folk and craftsmen of the far northern shore.",
    bonus: { label: "Forest wardens", detail: "Begin with Warcraft already known (the Barracks).", startTech: "warcraft" } },
  { name: "Gotland", color: "#9aa4b2", trait: "mercantile", disposition: "merchant", blurb: "Visby's island Hansa — the trading heart of the sea.",
    bonus: { label: "Hansa heart", detail: "Begin with +55 gold — the richest opening.", startGold: 55 } },
  { name: "Samogitia", color: "#c56b6b", trait: "martial", disposition: "warlord", blurb: "Fierce pagan holdouts who bow to no crusader.",
