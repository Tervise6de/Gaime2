...
export const KONTORE: Record<KontorId, KontorDef> = {
  novgorod: {
    ...
    regionId: 62,
    demands: ["furs", "timber", "beer", "cloth"],
    leagueIncome: 4,
  ...
  bergen: {
    ...
    name: "Bryggen (Bergen)",
    regionId: 30,
    demands: ["grain", "salt", "beer", "brick", "copper", "cloth", "honey"],
    leagueIncome: 2,
  ...
  bruges: {
    ...
    regionId: 5,
    demands: ["grain", "iron", "salt", "herring", "amber", "stockfish", "naval_stores", "copper", "wax", "honey", "wool"],
    leagueIncome: 5,
  ...
  london: {
    ...
    regionId: 0,
    demands: ["furs", "iron", "herring", "amber", "stockfish", "naval_stores", "wax", "wool"],
    leagueIncome: 5,
